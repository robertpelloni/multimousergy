...
void test_network_concurrency() {
    ...
    for (int i = 0; i < (int)clients.size(); ++i) {
        Packet p = { (unsigned long long)i + 1, 0, 0, 0.0, NetMuxPacketType::AbsoluteMovement, 100 * i, 100 * i, 0, false, false, 0, 0, "", 0 };
...
void test_group_isolation() {
    ...
    Packet p1 = { 101, 1, 0, 0.0, NetMuxPacketType::AbsoluteMovement, 500, 500, 0, false, false, 0, 0, "", 0 };
    c1.SendPacket(p1);

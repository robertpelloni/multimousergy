...
static HWND s_hwndHALDriverType = nullptr;
...
LRESULT CALLBACK SettingsWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    switch (msg) {
        case WM_CREATE:
            ...
            s_hwndHALDriverType = CreateWindow("COMBOBOX", "", WS_VISIBLE | WS_CHILD | CBS_DROPDOWNLIST, 70, 330, 100, 100, hwnd, (HMENU)ID_DRIVER_TYPE, NULL, NULL);
            SendMessage(s_hwndHALDriverType, CB_ADDSTRING, 0, (LPARAM)"Auto");
            SendMessage(s_hwndHALDriverType, CB_ADDSTRING, 0, (LPARAM)"Interception");
            SendMessage(s_hwndHALDriverType, CB_ADDSTRING, 0, (LPARAM)"ViGEmBus");
            SendMessage(s_hwndHALDriverType, CB_SETCURSEL, (WPARAM)s_currentSettings->driverType, 0);
        ...
        case WM_COMMAND:
            if (LOWORD(wParam) == ID_SAVE_BUTTON) {
                ...
                try {
                    ...
                    s_currentSettings->driverType = (HALDriverType)SendMessage(s_hwndHALDriverType, CB_GETCURSEL, 0, 0);
